...
<?php
    ...
    if (mysql_num_rows($result)==0) {
        ...
        $regCAT = mysql_fetch_array($result);
...
<body>
	...
	<div id="tagre">
		...
		<form id="dataFPR" action ="ProcesomodcatUPD.php" method="POST">
			<table>
			<tr>
                <td>ID:</td>
                <td>
            ...
            <tr>
                ...
                <td>
                <?php
                    echo "<input id='dataCAT' type='text' name='CAT' value='$categoria'/>";
                    ?>
                </td>
            </tr>
         ...
         <tr>
            <td colspan="2">
                <input type="button" value="Actualizar" onclick="CheckCAT();"> 
