...
<body>
	...
	<div id="tagre">
		...
		<form id="dataFPR" action ="Procesodelprod.php" method="POST">
			<table>
			<tr>
                <td>ID:</td>
                <td>
			...
			<tr>
                <td>Descripcíon:</td>
                <td>
                    <input id="dataDES" type="text" name="DES" disabled>
                </td>
            </tr>
            <tr>
                <td>Precio:</td>
                <td>
                    <input id="dataPRE" type="text" name="PRE" disabled>
                </td>
            </tr>
            <tr>
                <td>Marca:</td>
                <td>
                    <input id="dataMAR" type="text" name="MAR" disabled>
                </td>
            </tr>
            ...
            <tr>
                <td>Categoría:</td>
                <td>
                    <input id="dataCAT" type="text" name="CAT" disabled>
                </td>
            </tr>
            ...
            <tr>
                <td>Tienda:</td>
                <td>
                    <input id="dataTIE" type="text" name="TIE" disabled>
                </td>
            </tr>
         <tr>
            <td colspan="2">
